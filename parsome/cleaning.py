...
from recursive import recursive_clean
from recursive_clean import recursive_clean_ipa, recursive_clean_lang, recursive_clean_convert
...
def post_clean(text):
    ...
    # additions
    text = re.sub('\u2013', '-', text)
    text = re.sub(r'\s((\\u)([A-Za-z0-9]+))+\s', ' ', text)
